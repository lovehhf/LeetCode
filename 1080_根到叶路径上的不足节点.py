...
class Solution(object):
    def helper(self, root, limit):
        ...
        return self.helper(root.left, limit - root.val) or self.helper(root.right, limit - root.val)
    ...
    def sufficientSubset(self, root, limit):
        ...
        if not root:
            return root
        if not self.helper(root.left, limit - root.val) and not self.helper(root.right, limit - root.val):
            return None
        if root.left:
